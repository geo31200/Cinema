...
class TestCinema {
	...
	Collections.addAll(movies, 
			...
			new Movie ("Avengers - l'�re d'ultron", 2015, 141)
			);
	...
	@Test // relie les films et les r�alisateurs
...
//		.forEach(System.out::println);
	...
	void AvengersFirtYears() 
	{
		...
		.min();
		System.out.println(" La premi�re ann�e de sortie d'Avengers est : " + FirstYears);
	}
	...
	void AvengersStats() 
	{
		...
		.mapToInt(Movie::getYear)
		.summaryStatistics();
		System.out.println(" La derni�re ann�e de sortie d'Avengers est : " + Stats.getMin());
		System.out.println(" La derni�re ann�e de sortie d'Avengers est : " + Stats.getMax());
